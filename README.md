...
**New here?** Start with **[`GUIDE.md`](GUIDE.md)** — a readable tour of the project (WhatsApp, grounded AI, memory strategy). For a compact technical map, see **[`ARCHITECTURE.md`](ARCHITECTURE.md)**.
